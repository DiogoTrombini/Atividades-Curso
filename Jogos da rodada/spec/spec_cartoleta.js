...
describe("Teste de validação valor_do_jogo ", function() {
  ...
  it("Valores Sorteio do Placar ", function() {
	...
	expect( sorteio() ).____ (-1);
	
	expect( sorteio() ).____ (5);
	
	expect( sorteio() ).____ (6);
...
describe("Teste de validação validar_pontos ", function() {
  ...
  it("Validar Campeões ", function() {
	...
	expect( validar_pontos(1,3) ).____ ("Vitória do Time 2");

	expect( validar_pontos(3,1) ).____ ("Vitória do Time 1");

	expect( validar_pontos(1,1) ).____ ("Empate");
...
describe("Teste de validação validar_pontos INVALIDOS", function() {
  ...
  it("Validar Campeões ", function() {
	...
	expect( validar_pontos(3,1) ).____ ("Vitória do Time 2");	
	
	expect( validar_pontos(1,3) ).____ ("Vitória do Time 1");	
	
	expect( validar_pontos(3,1) ).____ ("Empate");
